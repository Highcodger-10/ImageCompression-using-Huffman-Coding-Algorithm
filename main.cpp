...
int main(int argc, char** argv)
{
	...
	Compressor c;
  // char* str = "D:/4thsem/4th semester/DSA_ImageCompressionproject/lena.png" ;
	// c.compress(str);
  ...
  char* compressedfile = "D:/4thsem/4th semester/DSA_ImageCompressionproject/lena.compressed";
